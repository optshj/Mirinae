...
export function Calendar() {
    ...
    return (
        <div className="[html.disable-click_&]:pointer-events-none [html.resizable_&]:mb-4 [html.resizable_&]:box-border [html.resizable_&]:border-4 [html.resizable_&]:border-dotted [html.resizable_&]:border-[#e0e0e0]">
